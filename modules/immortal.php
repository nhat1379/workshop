<?php
	...
	$item = mysqli_query ($conn,"SELECT * FROM d2_item where type_id != 7 && type_id = 1 order by item_price desc limit $pg,12");
...
<?php
	$page = mysqli_query ($conn,"SELECT * FROM d2_item where type_id != 7 && type_id = 1");
...
?>
		...
		<ul class="pagination">
			...
			?>
				<li><a href="index.php?view=immortal&pg=<?php echo	 $_GET['pg'] - 1 ?>"><i class="fa fa-angle-left"></i> Prev</a></li>
			<?php
				}
			?>	
			<!--/Previous-->
			...
			<?php
				...
				if ($page == $b) {
			?>
					<li class="active"><a href="index.php?view=immortal&pg=<?php echo $b ?>"> <?php echo $b; ?></a></li>
			<?php
				}else{ 
			?>			
				<li><a href="index.php?view=immortal&pg=<?php echo $b ?>"> <?php echo $b; ?></a></li>
			<?php
				}
			?>
			<?php
