...
?>
		...
		<ul class="pagination">
			...
			?>
				<li><a href="index.php?view=set&pg=<?php echo	 $_GET['pg'] - 1 ?>"><i class="fa fa-angle-left"></i> Prev</a></li>
			<?php
				}
			?>	
			<!--/Previous-->
			...
			<?php
				...
				if ($page == $b) {
			?>
					<li class="active"><a href="index.php?view=set&pg=<?php echo $b ?>"> <?php echo $b; ?></a></li>
			<?php
				}else{ 
			?>			
				<li><a href="index.php?view=set&pg=<?php echo $b ?>"> <?php echo $b; ?></a></li>
			<?php
				}
			?>
			<?php
			...
			<?php
				if ($page ==''){
					$page = 1; 
			?>
				<li><a href="index.php?view=set&pg=<?php echo $page + 1 ?>">Next <i class="fa fa-angle-right"></i></a></li>
			<?php
				}elseif ($page == $a) {
			?>
			...
			?>
				<li><a href="index.php?view=set&pg=<?php echo $_GET['pg']+1 ?>">Next <i class="fa fa-angle-right"></i></a></li>
			<?php
				}
			?>
